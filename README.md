...
[Results are published to GitHub Pages]([https://solid-bassoon-mvjk2mp.pages.github.io/](https://aem-growth-adoption.github.io/aem-growth-arco-benchmark/)) after each push to `main`.
